...
export const AnsiSpan = styled('span')<{ customstyle: CSSProperties }>(({ customstyle }) => ({ ...customstyle }));

export const renderAnsi = (text?: string | null) => {
    if (!text) return null;
    ...
    return parts.map((part, i) => {
        ...
        return <AnsiSpan key={i} customstyle={{ ...currentStyle }}>{part}</AnsiSpan>;
    });
};