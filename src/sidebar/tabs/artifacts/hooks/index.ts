...
import type { ArtifactsLocalState, UseArtifactsReturn } from './types'
import type { Artifact, FetchViaBackground } from '@/sidebar/types'

const useArtifacts = (fetchViaBackground: FetchViaBackground): UseArtifactsReturn => {
    const { serverUrl, checkInterval, removeComments, removeEmptyLines, removeLogs, translateCommit, autoSelectSynced, setRemoveComments, setTranslateCommit } = useConfigStore()
